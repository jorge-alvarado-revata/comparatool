...
draw_graph(G, 'images/sis2018/G_2009.png', f_sis2009)
...
draw_graph(H, 'images/sis2018/H_sis2018_cmp_sis2009_m1.png', f_sis2018_sis2009)
print("modelo 1:")
...
draw_graph(H, 'images/sis2018/H_sis2018_cmp_sis2009_m1_mcs.png', f_sis2018_sis2009, mcs)
draw_mix_graph(H, 'images/sis2018/H_sis2018_cmp_sis2009_m1_mcs_mix.png', f_sis2018_sis2009, mcs, G)

# sistemas 2009 model 2 (relaciones originales de la carrera)

T = factory_graph(f_sis2018_sis2009, f_sis2018_sis2009_m2)
draw_graph(T, 'images/sis2018/H_sis2018_cmp_sis2009_m2.png', f_sis2018_sis2009)
...
draw_graph(T, 'images/sis2018/H_sis2018_cmp_sis2009_m2_mcs.png', f_sis2018_sis2009, mcs)
draw_mix_graph(T, 'images/sis2018/H_sis2018_cmp_sis2009_m2_mcs_mix.png', f_sis2018_sis2009, mcs, G)
...
draw_graph(G, 'images/acm2013/G_acm2013.png', f_acm2013)
...
draw_graph(H, 'images/sis2018/H_sis2018_cmp_acm2013_m1_mcs.png', f_sis2018_acm2013, mcs)
draw_mix_graph(H, 'images/sis2018/H_sis2018_cmp_acm2013_m1_mcs_mix.png', f_sis2018_acm2013, mcs, G)
...
draw_graph(T, 'images/sis2018/H_sis2018_cmp_acm2013_m2.png', f_sis2018_acm2013)
print("Modelo 2")
...
ged = distance(num_node, len(G.nodes), len(T.nodes))
print(ged)
draw_graph(T, 'images/sis2018/H_sis2018_cmp_acm2013_m2_mcs.png', f_sis2018_acm2013, mcs)
draw_mix_graph(T, 'images/sis2018/H_sis2018_cmp_acm2013_m2_mcs_mix.png', f_sis2018_acm2013, mcs, G)
